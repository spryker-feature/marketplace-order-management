...
- [MerchantSalesOrderThresholdGui ^1.1.0](https://github.com/spryker/merchant-sales-order-threshold-gui) (Connector)
- [ProductOfferSalesRestApi ^1.1.0](https://github.com/spryker/product-offer-sales-rest-api) (Legacy Glue)
- [SalesMerchantPortalGui ^4.0.0](https://github.com/spryker/sales-merchant-portal-gui) (MP GUI)
